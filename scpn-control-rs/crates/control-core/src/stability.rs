...
use control_math::interp::{gradient_2d, interp2d};
use control_math::linalg::eig_2x2;
use control_types::config::ReactorConfig;
use control_types::constants::MU0_SI;
use control_types::error::{FusionError, FusionResult};
use control_types::state::{Grid2D, StabilityResult};
use ndarray::Array2;
...
///
/// Returns radial and vertical force in newtons.
///
