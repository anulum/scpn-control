...
class GKCorrector:
    ...
    def update(
        ...
        new_alpha_i = np.interp(rho, spot_rho, spot_alpha_i, left=spot_alpha_i[0], right=spot_alpha_i[-1])
        new_alpha_e = np.interp(rho, spot_rho, spot_alpha_e, left=spot_alpha_e[0], right=spot_alpha_e[-1])
        new_alpha_d = np.interp(rho, spot_rho, spot_alpha_d, left=spot_alpha_d[0], right=spot_alpha_d[-1])
