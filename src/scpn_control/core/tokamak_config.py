...
class TokamakConfig:
    ...
    def iter(cls) -> TokamakConfig:
        ...
        return cls(
            name="ITER", R0=6.2, a=2.0, B0=5.3, Ip=15.0,
            kappa=1.7, delta=0.33, n_e=10.1, T_e=25.0, P_aux=50.0,
        )
    ...
    def sparc(cls) -> TokamakConfig:
        ...
        return cls(
            name="SPARC", R0=1.85, a=0.57, B0=12.2, Ip=8.7,
            kappa=1.97, delta=0.54, n_e=30.0, T_e=21.0, P_aux=25.0,
        )
    ...
    def diiid(cls) -> TokamakConfig:
        ...
        return cls(
            name="DIII-D", R0=1.67, a=0.67, B0=2.1, Ip=1.5,
            kappa=1.8, delta=0.4, n_e=5.0, T_e=4.0, P_aux=10.0,
        )
    ...
    def jet(cls) -> TokamakConfig:
        ...
        return cls(
            name="JET", R0=2.96, a=1.25, B0=3.45, Ip=3.5,
            kappa=1.68, delta=0.3, n_e=7.0, T_e=8.0, P_aux=25.0,
        )
