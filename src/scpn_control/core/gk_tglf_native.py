...
def sat2(
    ...
    gamma_itg_max = gamma_net[ion_mask].max() if ion_mask.any() and gamma_net[ion_mask].max() > 0 else 1e-10
...
class TGLFNativeSolver(GKSolverBase):
    ...
    def solve(self, params: GKLocalParams) -> TGLFNativeResult:
        ...
        chi_i, chi_e, D_e, V_e, chi_e_etg = quasilinear_weights(linear, phi_sq, gamma_net, 2.0, params.T_i_keV, params)
