...
# SCPN Control — Artifact load / save / schema product surface.
"""
SCPN Controller Artifact (``.scpnctl.json``) loader / saver.

Re-exports the topology model, validation leaf, and compact packed-weight codec,
and owns load/save, JSON schema emission, and payload hashing. Structural
validation lives in :mod:`scpn_control.scpn.artifact_validate` (CTL-G07 R4-S2);
compact codec lives in :mod:`scpn_control.scpn.artifact_codec` (CTL-G07 R4-S3).
"""
...
# ── Compact codec (re-exported from artifact_codec; CTL-G07 R4-S3) ───────────
