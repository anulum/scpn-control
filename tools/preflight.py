...
GATES: list[tuple[str, list[str], Path | None]] = [
    ...
    ("document-links", [_PY, "tools/document_link_audit.py"], None),
    ...
    ("coverage-exception-ledger", [_PY, "tools/coverage_exception_ledger.py", "--check"], None),
