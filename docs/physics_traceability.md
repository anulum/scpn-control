...
- Status: pass
- Registry entries: 71
- Open fidelity gaps: 70
- Full-fidelity public claims blocked: 70
- Resolved module paths: 71
- Resolved evidence paths: 636
...
- Plasma-control and facility replay artefacts: [#51](https://github.com/anulum/scpn-control/issues/51) — 16 open claim(s) (validation_gap=1, bounded_model=15) — RZIP, RWM, free-boundary, density, digital twin, SOC learning, burn, volt-second, static structured-mu analysis, future D-K synthesis, and reduced-plant replay evidence.
