...
- Status: pass
- Registry entries: 62
- Open fidelity gaps: 61
- Full-fidelity public claims blocked: 61
- Resolved module paths: 62
- Resolved evidence paths: 560
- External validation trackers: 8
- Source marker coverage: 35/35
...
- Disruption, halo-current, and mitigation benchmark artefacts: [#52](https://github.com/anulum/scpn-control/issues/52) — 5 open claim(s) (bounded_model=5) — Measured disruption databases, labelled disruption windows, halo/runaway envelopes, wall contact, impurity radiation, and mitigation metadata.
