...
- Required actions:
  ...
  - Keep tamper-evident replay manifests attached with magnetic-configuration provenance, actuator calibration, latency evidence, acceptance thresholds, and digest validation
