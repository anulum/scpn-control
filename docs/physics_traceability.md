...
- Status: pass
- Registry entries: 55
- Open fidelity gaps: 54
- Full-fidelity public claims blocked: 54
- Resolved module paths: 55
- Resolved evidence paths: 365
...
- Plasma-control and facility replay artefacts: [#51](https://github.com/anulum/scpn-control/issues/51) — 13 open claim(s) — RZIP, RWM, free-boundary, density, digital twin, SOC learning, burn, volt-second, mu-synthesis, and reduced-plant replay evidence.
