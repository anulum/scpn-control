...
- Status: pass
- Registry entries: 61
- Open fidelity gaps: 60
- Full-fidelity public claims blocked: 60
- Resolved module paths: 61
- Resolved evidence paths: 552
- External validation trackers: 8
- Source marker coverage: 34/34
...
- Equilibrium and reconstruction reference artefacts: [#48](https://github.com/anulum/scpn-control/issues/48) — 6 open claim(s) (validation_gap=2, bounded_model=4) — DIII-D or equivalent shots, EFIT, P-EFIT, GEQDSK, VMEC, and stellarator replay artefacts.
