...
.PHONY: test test-rust test-all lint fmt bandit sast preflight preflight-fast docs docs-build docs-api-rust bench bench-rust bench-native-handoff bridge build install-hooks docker-build docker-run clean
