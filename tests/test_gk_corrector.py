...
# ──────────────────────────────────────────────────────────────────────
# SCPN Control — Test Gk Corrector
...
# ──────────────────────────────────────────────────────────────────────
# SCPN Control — GK Corrector Tests
# ──────────────────────────────────────────────────────────────────────
...
def test_replace_mode(rho50):
    corr = GKCorrector(nr=50, config=CorrectorConfig(mode="replace", smoothing_alpha=1.0, replace_threshold=0.3))
    ...
    corr2 = GKCorrector(nr=50, config=CorrectorConfig(mode="replace", smoothing_alpha=1.0, replace_threshold=0.3))
