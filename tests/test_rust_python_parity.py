...
# ──────────────────────────────────────────────────────────────────────
# SCPN Control — Test Rust Python Parity
...
# ──────────────────────────────────────────────────────────────────────
# SCPN Control — Rust/Python Parity Tests
...
Verifies that the Rust (scpn_control_rs) and pure-Python code paths produce
...
pytestmark = pytest.mark.skipif(not HAS_RUST, reason="Rust bindings (scpn_control_rs) not available")
...
class TestTransportSolverParity:
    ...
    def test_tearing_mode_parity(self) -> None:
        ...
        from scpn_control.core._rust_compat import rust_simulate_tearing_mode
