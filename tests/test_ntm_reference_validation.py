...
def _valid_ntm_reference_artifact() -> dict[str, object]:
    payload: dict[str, object] = {
        ...
        "rational_surface": {"rho": 0.6, "r_s_m": 1.2, "m": 2, "n": 1, "q": 2.0, "shear": 1.25, "a_m": 2.0, "R0_m": 6.2},
        "seed_island_width_range_m": [0.004, 0.025],
        "eccd_alignment": {"power_W": 3.0e6, "current_A": 1.8e5, "deposition_width_m": 0.045, "alignment_error_m": 0.012},
        "metrics": {
