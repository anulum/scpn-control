...
# ──────────────────────────────────────────────────────────────────────
# SCPN Control — Test Gs Convergence
...
# ──────────────────────────────────────────────────────────────────────
# SCPN Control — Grad-Shafranov Convergence Tests
# © 1998–2026 Miroslav Šotek. All rights reserved.
# Contact: www.anulum.li | protoscience@anulum.li
# ORCID: https://orcid.org/0009-0009-3560-0851
...
_ALL_GEQDSK = sorted(list(_SPARC_DIR.glob("lmode_*.geqdsk")) + list(_SPARC_DIR.glob("sparc_*.eqdsk")))
...
class TestSORConvergence:
    ...
    def test_sor_wall_time(self, geqdsk_path, tmp_path):
        ...
        assert result["wall_time_s"] < 2.0, f"SOR took {result['wall_time_s']:.2f}s on {geqdsk_path.stem}"
...
class TestResidualHistory:
    ...
    def test_residual_trend_decreasing(self, tmp_path):
        ...
        if len(hist) >= 20:
            ...
            assert last_10 < first_10, f"Residual not decreasing: first_10={first_10:.2e}, last_10={last_10:.2e}"
