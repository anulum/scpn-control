...
# ──────────────────────────────────────────────────────────────────────
# SCPN Control — Test Gk Quasilinear
...
# ──────────────────────────────────────────────────────────────────────
# SCPN Control — Quasilinear Flux Model Tests
# ──────────────────────────────────────────────────────────────────────
...
def test_quasilinear_chi_increases_with_gradient():
    ...
    r_weak = solve_linear_gk(
        species_list=[
            ion_weak,
            deuterium_ion.__wrapped__(R_L_T=3.0) if hasattr(deuterium_ion, "__wrapped__") else ion_weak,
        ],
        n_ky_ion=4,
        n_theta=16,
        n_period=1,
    ...
    r_strong = solve_linear_gk(
        species_list=[
            ion_strong,
            deuterium_ion.__wrapped__(R_L_T=12.0) if hasattr(deuterium_ion, "__wrapped__") else ion_strong,
        ],
        n_ky_ion=4,
        n_theta=16,
        n_period=1,
