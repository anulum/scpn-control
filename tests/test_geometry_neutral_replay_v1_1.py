...
def _aer_admission_metadata() -> dict[str, object]:
    ...
    return build_aer_admission_metadata(
...
def test_v1_1_replay_attaches_digest_bound_aer_admission_metadata(tmp_path) -> None:
    report = _v1_1_report()
...
def test_v1_1_replay_rejects_impossible_aer_retention_count() -> None:
    metadata = _aer_admission_metadata()
    metadata["retained_events"] = metadata["capacity"] + 1
