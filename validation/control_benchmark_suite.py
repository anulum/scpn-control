# ──────────────────────────────────────────────────────────────────────
# SCPN Control — Integrated Control Benchmark Suite
# ──────────────────────────────────────────────────────────────────────
...
class BenchmarkRunner:
    ...
    def _run_single(self, controller: ControllerWrapper, scenario: BenchmarkScenario) -> BenchmarkResults:
...
def setpoint_tracking() -> BenchmarkScenario:
    ...
    return BenchmarkScenario(
        name="setpoint_tracking", env_config={"dt": 0.05}, reference_trajectory=ref, duration_s=10.0, n_episodes=1
    )
