...
# ──────────────────────────────────────────────────────────────────────
# SCPN Control — Tutorial 03 Ppo Rl Agent
...
try:
    ...
    print(f"  Final T_axis: {obs[0]:.2f} keV")
    print("  (Committed 500K benchmark artifact records reward 121.1)")
...
print("═" * 60)
print("  Committed benchmark artifact (500K training, 50 episodes):")
print()
print(f"  {'Controller':>12s}  {'Reward':>8s}  {'Disruption':>10s}")
print(f"  {'─' * 12}  {'─' * 8}  {'─' * 10}")
print(f"  {'PPO':>12s}  {'121.1':>8s}  {'0%':>10s}")
print(f"  {'MPC':>12s}  {'59.4':>8s}  {'0%':>10s}")
print(f"  {'PID':>12s}  {'-911.2':>8s}  {'0%':>10s}")
print()
print("  PPO exceeds the 1-step MPC benchmark reward while")
print("  maintaining 0% disruption rate in the committed artifact.")
print()
